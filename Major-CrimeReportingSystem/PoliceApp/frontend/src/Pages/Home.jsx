      ...
      <section className="bg-black text-white py-5 text-center">
        <Container>
          ...
          <div className="mt-4 d-flex flex-column flex-md-row justify-content-center align-items-center">
            <Button as={Link} to="/report/police" variant="warning" size="lg" className="me-md-3 mb-3 mb-md-0">
              Check Reports
            </Button>
            <Button as={Link} to="/alert/send" variant="danger" size="lg" className="me-md-3 mb-3 mb-md-0">
              Send Alerts
            </Button>
          </div>
        </Container>
